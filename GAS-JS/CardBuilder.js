      ...
      switch (_context.prev = _context.next) {
        ...
        case 24:
          ...
          sections.forEach(function (obj) {
            var section = obj.s;
            var numuncoll = obj.u;
            var collapsible = section.querySelector('.collapsible');

            if (collapsible !== null) {
              var overlay = collapsible.querySelector('form');

              if (overlay === null) {
                overlay = collapsible;
              }

              var toggler = section.querySelector('.toggler');
              var initial = uncollapsible(numuncoll, overlay);
