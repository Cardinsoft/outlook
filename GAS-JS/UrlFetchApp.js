...
var HTTPResponse = function HTTPResponse(headers, content, code) {
...
var e_UrlFetchApp = function e_UrlFetchApp() {
...
function () {
  ...
  /*#__PURE__*/
  _regeneratorRuntime.mark(function _callee(url, params) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 15:
            ...
            checkResp = _typeof(response) === 'object'; //make sure response is parsed;

            if (!checkResp) {
              checkResp = (_readOnlyError("checkResp"), JSON.parse(response));
...
var UrlFetchApp = new e_UrlFetchApp();
/**
...
function makeRequest(url, params) {
  return new Promise(function (resolve, reject) {
    ...
    if (params.headers) {
      ...
      var hs = params.headers; //set request header for each param header;
    ...
    request.ontimeout = function () {
      var statusText = request.statusText; //construct timeout response object;
