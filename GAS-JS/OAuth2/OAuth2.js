...
let e_OAuth2 = function e_OAuth2() {
  (0, _classCallCheck2.default)(this, e_OAuth2);
  this.service;
};
/**
...
Service.prototype.setScope = function (scope) {
  ...
  let require = scopes.require; //add scope to scopes list;
...
Service.prototype.hasAccess = function () {
  //initiate Service with set parameters;
  const service = this.build(); //await for token;
