...
/**
 * Sets the name of the authorization callback function (required). This is the function that will be called when the user completes the authorization flow
 * on the service provider's website. The callback accepts a request parameter, which should be passed to this service's <code>handleCallback()</code> method to complete the process.
...
function getRedirectUri() {
  return 'https://cardinsoft.github.io/outlook/OAuth2-result.html';
}
